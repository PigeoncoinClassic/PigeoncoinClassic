...
class TxnMallTest(PigeonTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 PGC:
        ...
        # First: use raw transaction API to send 1240 PGC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 PGC coin each
        ...
        # Node0's total balance should be starting balance, plus 100PGC for 
