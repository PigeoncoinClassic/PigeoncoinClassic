...
VERSION=
commit=false
url=https://github.com/PigeoncoinClassic/PigeoncoinClassic
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/PigeoncoinClassic/PigeoncoinClassic
...
then
    ...
    git clone https://github.com/PigeoncoinClassic/gitian.sigs.git
    git clone https://github.com/PigeoncoinClassic/pigeon-detached-sigs.git
